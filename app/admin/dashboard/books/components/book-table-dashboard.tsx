...
export default function BookTableDashboard() {
  return (
    <>
      <div className="relative mt-4 overflow-x-auto border-t pt-4 shadow-md sm:rounded-lg">
        <div className="flex items-center justify-between px-4 pb-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              id="table-search"
              className="block w-80 rounded-lg border border-gray-300 bg-gray-50 p-2 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
